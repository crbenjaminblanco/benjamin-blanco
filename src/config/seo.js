export const DEFAULT_SEO_CONFIG = {
  title: 'Benjamin Blanco Calendars - Tu Escape Perfecto en la Naturaleza',
  titleTemplate: '%s | Benjamin Blanco Calendars',
  description: 'Descubre Benjamin Blanco Calendars, un refugio único rodeado de naturaleza en Zarcero, Costa Rica. Experimenta la tranquilidad y el confort en nuestras cabañas exclusivas cerca del parque.',
  keywords: 'Benjamin Blanco Calendars, cabañas, Zarcero, Costa Rica, parque nacional, naturaleza, hospedaje, descanso, turismo, alojamiento, vacaciones Costa Rica, cabañas Zarcero, turismo Zarcero, alojamiento Costa Rica, montaña, clima fresco',
  openGraph: {
    type: 'website',
    locale: 'es_ES',
    url: 'https://nidodelparque.com',
    siteName: 'Benjamin Blanco Calendars',
    images: [
      {
        url: '/images/og-image.jpg',
        width: 1200,
        height: 630,
        alt: 'Benjamin Blanco Calendars - Vista panorámica en Zarcero, Costa Rica'
      }
    ]
  },
  twitter: {
